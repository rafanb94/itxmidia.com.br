			...
			<div class="container">
				<div class="row">
					<div id="hero-section" class="col-12 col-md-5">
						...
						<a class="btn btn-cta btn-lg mt-5"href="">solicitar orçamento</a>
					</div>
				...
				<div class="row justify-content-between">
					...
					<div class="col-5 pt-5">
						...
						<div class="traffic-img pt-5">
							...
							<div class="mt-3">
								<a class="btn btn-cta btn-lg d-block mx-auto" href="">solicitar orçamento</a>
							</div>
						</div>
					</div>
				</div>
		...
		<section class="s-att mt-5 py-5 d-flex align-items-center">
			<div class="container">
				...
				<div class="row mt-5">
					...
					<div class="col-4">
						<header>
							<h3 class="h3-white mb-3">Sem uma estratégia</h3>
						</header>
			...
			<div class="container">
				...
				<div class="row mt-5">
					...
					<div class="col-6">
						...
						<a class="btn btn-cta btn-lg d-block mx-auto" href="">falar com um especialista</a>
					</div>	
				</div>
			</div>
		</section>
